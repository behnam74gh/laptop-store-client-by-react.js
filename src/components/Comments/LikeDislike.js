...
const LikeDislike = ({ commentId, userId }) => {
  ...
  useEffect(() => {
    axios
      .post(`${process.env.REACT_APP_API}/like/getLikes`, {
        commentId,
        userId,
      })
      .then((res) => {
    ...
    axios
      .post(`${process.env.REACT_APP_API}/dislike/getdisLikes`, {
        commentId,
        userId,
      })
      .then((res) => {
  ...
  const onLikeHandler = () => {
    if (likeAction === null) {
      axios
        .post(`${process.env.REACT_APP_API}/like/uplike`, {
          commentId,
          userId,
        })
        .then((res) => {
      ...
      axios
        .post(`${process.env.REACT_APP_API}/like/unlike`, {
          commentId,
          userId,
        })
        .then((res) => {
  ...
  const onDislikeHandler = () => {
    if (dislikeAction === null) {
      axios
        .post(`${process.env.REACT_APP_API}/dislike/updislike`, {
          commentId,
          userId,
        })
        .then((res) => {
      ...
      axios
        .post(`${process.env.REACT_APP_API}/dislike/undislike`, {
          commentId,
          userId,
        })
        .then((res) => {
